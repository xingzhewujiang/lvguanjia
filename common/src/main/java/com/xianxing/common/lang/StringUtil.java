...
public class StringUtil {
    ...
    /**
	 * 描述：  按照指定的分隔符来切割字符串，并拼接指定长度的字符串.</br>
	 * @param str		源字符串
	 * @param reg		分隔符
	 * @param count		指定长度
	 * @return {String}
	 * @author kevinZhang
	 */
	public static String splitString(String str, String reg, int count)
	{
		String[] sArray = str.split(reg);
		
		if (sArray != null && sArray.length > count)
		{
			String result = "";
	...
	public static void main(String[] args)
	{
		...
		String str = "ab,c,d,efg";
		
		System.out.println(splitString(str, ",",1));
